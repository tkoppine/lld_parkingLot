error id: file://<WORKSPACE>/domain/ParkingSlot.java
file://<WORKSPACE>/domain/ParkingSlot.java
...
```java
offset: 469
uri: file://<WORKSPACE>/domain/ParkingSlot.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/domain/ParkingSlot.java